...
export const AboutComponent = function() {
    ...
    <div className='py-5 px-5 mx-auto max-w-xl'>
        <div>
            ...
            <p className='pt-3'> <strong>Vertreten durch: </strong><br />
                Max Muster<br />
            </p>
            <p className="pt-3"><strong>Kontakt:</strong> <br />
                Telefon: 01234-789456<br />
                Fax: 1234-56789<br />
                E-Mail: <a href='mailto:max@muster.de'>max@muster.de</a><br /></p>
            <p className='pt-3'><strong>Umsatzsteuer-ID: </strong> <br />
                Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: Musterustid.<br />
                <br className='pt-3'/><strong>Wirtschafts-ID: </strong><br/>
                Musterwirtschaftsid<br />
            </p>
            <p className='pt-3'><strong>Aufsichtsbehörde:</strong><br />
                Musteraufsicht Musterstadt<br /></p>
            <p className='pt-3'><strong>Haftungsausschluss: </strong><br />
                ...
                <br /></p><strong>Urheberrecht</strong><br />
